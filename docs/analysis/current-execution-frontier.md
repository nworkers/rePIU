...
| 1''' | **타이머 틱 coalescing** — 174초에 due 41,531 / injected 39,830 / **coalesced 1,677**. 음악은 실시간으로 정확한데 게스트 틱은 손실되므로, 사용자가 보고한 **노트·BGA 점프**의 직접 후보 | 음악 위치는 결백함이 확정됨(위치 오차 0) | 미측정 |

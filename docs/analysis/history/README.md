# 실행 frontier 이력 / Execution frontier history

이 디렉터리는 `current-execution-frontier.md`에서 분리한 과거 분석 원문을 보존합니다.
현재 결론은 상위 디렉터리의 current 문서를 사용하고, 정정·기각을 포함한 시간순 증거가

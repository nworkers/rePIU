...
```
AOT return stage profile enabled/returns/outer/max-outer/covered/coverage/residual: ...
AOT return stage cycles entry/read/resolve/patch/continuation: ...
AOT return stage counts entry/read/resolve/patch/continuation: ...
AOT return stage max entry/read/resolve/patch/continuation: ...
AOT return stage clamped residual/sample: ...
AOT return stage site: index=.. guest=.. miss_offset=.. observations=.. distinct=.. bypasses=.. megamorphic=..
```
...
```
AOT direct-return table enabled/sites/entries/hits/share/inserts/overwrites/clears: ...
```
...
AOT-DBT return fallback reason site/state/opcode/source/zero/hle/quarantine/non-guest/translate/unknown: ...
```
...
The pass-2 lines are `AOT return stage profile`, `... stage cycles`, `... stage counts`,
`... stage max`, `... stage clamped`, and one `AOT return stage site:` line per ranked
site.

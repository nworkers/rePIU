...
const std::vector<TargetProfile>& BuiltInTargetProfiles()
{
    static const std::vector<TargetProfile> profiles = {
        ...
        TargetProfile{
            "pumpitpr",
            "Pump It Up: The Premiere (MAME CHD)",
            std::filesystem::path(
                "build/runtime_mounts/pumpitpr/PIU/PIU.EXE"),
            std::filesystem::path("build/runtime_mounts/pumpitpr/PIU"),
            std::filesystem::path("build/runtime_mounts/pumpitpr"),
            ExecutableFormatHint::kDos4gwLe,
            "piu_common",
            "pumpitpr",
            TargetRuntimeReservationHint{
        ...
        TargetProfile{
            "pumpitpx",
            "Pump It Up: The Prex (MAME CHD)",
            std::filesystem::path(
                "build/runtime_mounts/pumpitpx/PIU/PIU.EXE"),
            std::filesystem::path("build/runtime_mounts/pumpitpx/PIU"),
            std::filesystem::path("build/runtime_mounts/pumpitpx"),
            ExecutableFormatHint::kDos4gwLe,
            "piu_common",
            "pumpitpx",
            TargetRuntimeReservationHint{
        ...
        TargetProfile{
            "pumpit8",
            "Pump It Up: The Rebirth (MAME CHD)",
            std::filesystem::path(
                "build/runtime_mounts/pumpit8/PIU/PIU.EXE"),
            std::filesystem::path("build/runtime_mounts/pumpit8/PIU"),
            std::filesystem::path("build/runtime_mounts/pumpit8"),
            ExecutableFormatHint::kDos4gwLe,
            "piu_common",
            "pumpit8",
            TargetRuntimeReservationHint{
        ...
        TargetProfile{
            "pumpitp2",
            "Pump It Up: The Premiere 2 (MAME CHD)",
            std::filesystem::path(
                "build/runtime_mounts/pumpitp2/PIU/PIU.EXE"),
            std::filesystem::path("build/runtime_mounts/pumpitp2/PIU"),
            std::filesystem::path("build/runtime_mounts/pumpitp2"),
            ExecutableFormatHint::kDos4gwLe,
            "piu_common",
            "pumpitp2",
            TargetRuntimeReservationHint{
        ...
        TargetProfile{
            "pumpipx2",
            "Pump It Up: The Prex 2 (MAME CHD)",
            std::filesystem::path(
                "build/runtime_mounts/pumpipx2/PIU/PIU.EXE"),
            std::filesystem::path("build/runtime_mounts/pumpipx2/PIU"),
            std::filesystem::path("build/runtime_mounts/pumpipx2"),
            ExecutableFormatHint::kDos4gwLe,
            "piu_common",
            "pumpipx2",
            TargetRuntimeReservationHint{
        ...
        TargetProfile{
            "pumpitp3",
            "Pump It Up: The Premiere 3 (MAME CHD)",
            std::filesystem::path(
                "build/runtime_mounts/pumpitp3/PIU/PIU.EXE"),
            std::filesystem::path("build/runtime_mounts/pumpitp3/PIU"),
            std::filesystem::path("build/runtime_mounts/pumpitp3"),
            ExecutableFormatHint::kDos4gwLe,
            "piu_common",
            "pumpitp3",
            TargetRuntimeReservationHint{
        ...
        TargetProfile{
            "pumpipx3",
            "Pump It Up: The Prex 3 (MAME CHD)",
            std::filesystem::path(
                "build/runtime_mounts/pumpipx3/PIU/PIU.EXE"),
            std::filesystem::path("build/runtime_mounts/pumpipx3/PIU"),
            std::filesystem::path("build/runtime_mounts/pumpipx3"),
            ExecutableFormatHint::kDos4gwLe,
            "piu_common",
            "pumpipx3",
            TargetRuntimeReservationHint{

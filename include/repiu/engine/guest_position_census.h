...
constexpr std::uint32_t kGuestPositionCensusCapacity = 4096U;
constexpr std::uint32_t kGuestPositionReportCapacity = 16U;
...
// smaller table.
constexpr std::uint32_t kGuestPositionHostSiteCapacity = 1024U;
constexpr std::uint32_t kGuestPositionHostSiteReportCapacity = 12U;
...
struct GuestPositionHostSiteEntry
{
    std::uint32_t address = 0;
    std::uint32_t sample_count = 0;
    bool occupied = false;
...
struct GuestPositionCensus
{
    ...
    std::array<GuestPositionHostSiteEntry,
               kGuestPositionHostSiteCapacity> host_sites = {};
    ...
    std::array<std::uint32_t, kGuestPositionOriginCount> origin_counts = {};
    std::array<GuestPositionEntry, kGuestPositionCensusCapacity>
        entries = {};
...
struct GuestPositionHostSiteSample
{
    std::uint32_t address = 0;
    std::uint32_t sample_count = 0;
...
struct GuestPositionCensusSnapshot
{
    bool enabled = false;
    std::uint32_t total_sample_count = 0;
    std::uint32_t distinct_address_count = 0;
    ...
    std::array<GuestPositionHostSiteSample,
               kGuestPositionHostSiteReportCapacity> host_site_top = {};
    std::array<std::uint32_t, kGuestPositionOriginCount> origin_counts = {};
    std::uint32_t top_count = 0;
    std::uint32_t top_coverage_count = 0;
    std::array<GuestPositionSample, kGuestPositionReportCapacity>
        top = {};
    ...
    std::array<std::string, kGuestPositionReportCapacity>
        top_module_names = {};
    std::array<std::uint32_t, kGuestPositionReportCapacity>
        top_module_offsets = {};
    bool dump_written = false;
    std::uint32_t dump_entry_count = 0;
...
constexpr std::uint32_t kGuestPositionCensusDefaultIntervalMs = 10U;
